...
export default function App() {
  ...
  const saveWord = async (finalWord, ai) => {
    const result = await sbFetch("/rest/v1/vocabulary", {
      method: "POST",
      body: JSON.stringify({ user_id:userId, word:finalWord, translation:ai.translation, type:ai.type, explanation:ai.explanation, sentences:ai.sentences, mastered:false })
    });
